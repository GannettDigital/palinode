...
describe('throttled-concurrent-all - practical tests', function() {
    ...
    describe('empty input, with numWorkers not set', function() {
        let callbackSpy;
    ...
    describe('empty input, with numWorkers set', function() {
        let callbackSpy;
    ...
    describe('some tasks fail, some tasks succeed, with numWorkers set greater than number of tasks', function() {
        let callbackSpy;
        let concurrentTasks;
    ...
    describe('empty input, with numWorkers set set greater than number of tasks', function() {
        let callbackSpy;
